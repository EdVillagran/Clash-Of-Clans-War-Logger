from clash_hearers import heading
import gspread
from oauth2client.service_account import ServiceAccountCredentials

def access_sheet():
    scope = ["https://spreadsheets.google.com/feeds",'https://www.googleapis.com/auth/spreadsheets',"https://www.googleapis.com/auth/drive.file","https://www.googleapis.com/auth/drive"]
    creds=ServiceAccountCredentials.from_json_keyfile_name("WarLogger-4370a595c230.json",scope)
    client=gspread.authorize(creds)
    sheet=client.open("Wee_Ones War").sheet1
...
def update_Sheet(players,):
    #Google sheets format is different than excels, it uses
    #row and column as numbers. 
